...
class Model:
    ...
    def __init__(self, batch_size, slope, num_pieces, lr, z_dim, raw_marginal):
    ...
    def create_model(self):
        ...
        self.d_optim = tf.train.GradientDescentOptimizer(self.lr).minimize(self.d_loss, var_list=self.d_vars)
        self.g_optim = tf.train.GradientDescentOptimizer(self.lr).minimize(self.g_loss, var_list=self.gx_vars+self.gz_vars)
